# Script triển khai lên server production
# Sử dụng: .\deploy-production.ps1
...
Write-Host "=== SCRIPT TRIỂN KHAI LÊN SERVER PRODUCTION ===" -ForegroundColor $Cyan
...
"@
    ...
    Write-Host "`n=== HOÀN THÀNH TRIỂN KHAI ===" -ForegroundColor $Green
    Write-Host "✓ Dự án đã được triển khai lên server thành công!" -ForegroundColor $Green
